<?php
	...
	if (isset($_GET['err'])){
		...
		$noteText = "Note: this will permanently remove this entry from your educational history";
	}
		...
		<div id="pageContent" align="center">
			<p>
				<div id="middleProfileInfo" >
					...
					echo("<input type=\"hidden\" name=\"schID\" value=\"".htmlspecialchars($schoolExperienceID, ENT_QUOTES)."\">\n");
					?>
					<ul>
