		...
		<div id="pageContent" align="center">
			<p>
				<div id="middleProfileInfo" >
					...
					<li class="addJobResume_form_li">
						<label for="currentSchool">Currently attending:</label>
						<input type="checkbox" name="currentSchool" value="yes">
					</li>
					<li class="addJobResume_form_li">
						<label for="schoolName">Name of school:</label>
						<input type="text" name="schoolName" maxlength="100" value="<?php echo htmlspecialchars($schoolName, ENT_QUOTES);?>" required>
					</li>
					<li class="addJobResume_form_li">
					...
					<li class="addJobResume_form_li">
						<label for="country">Country (if not USA):</label>
						<input type="text" name="country" maxlength="85" value="<?php echo htmlspecialchars($country, ENT_QUOTES);?>">
					</li>
					<li class="addJobResume_form_li">
						<label for="major">Major:</label>
						<input type="text" name="major" maxlength="100" value="<?php echo htmlspecialchars($major, ENT_QUOTES);?>">
					</li>
					<li class="addJobResume_form_li">
